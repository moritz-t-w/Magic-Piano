...
# Pianoteq Stage Trial Installation Script for Ubuntu
...
PKGNAME="pianoteq-stage-trial"
PKGVER="8.3.1"
NAME="Pianoteq ${PKGVER%%.*} STAGE"
...
# Extract archive
7z x "pianoteq_stage_linux_trial_v${PKGVER//./}.7z"
...
Type=Application
Name=$NAME
Comment=Physical modelling piano instrument standalone program, VST2 and LV2 plugin. STAGE trial version
Exec="$NAME"
Icon=${PKGNAME}
...
echo "Pianoteq Stage Trial has been installed successfully!"
